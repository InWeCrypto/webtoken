    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-menu"></i> 用户交易列表管理</el-breadcrumb-item>
        ...
        <div class="z-title">
            ...
            <el-input
                    placeholder="按订单号/hash/双方地址/转账方昵称查询"
                    icon="search"
                    v-model="options.keyword" class="z-search" style="width: 35%">
        ...
        <el-table :data="tableData" border style="width: 100%">
            <el-table-column type="expand" label="详情">
                <template scope="props">
                    <el-form label-position="right" inline class="demo-table-expand">
                        <el-form-item label="转账方OpenId">
                            <span>{{ props.row.user.open_id }}</span>
                        </el-form-item>
                        <el-form-item label="转账方昵称">
                            <span>{{ props.row.user.nickname }}</span>
                        </el-form-item>
                        <el-form-item label="转账地址">
                            <span>{{ props.row.address }}</span>
                        </el-form-item>
                        <el-form-item label="收账方OpenId">
                            <span>{{ props.row.receiver.user.open_id }}</span>
                        </el-form-item>
                        <el-form-item label="收账方昵称">
                            <span>{{ props.row.receiver.user.nickname }}</span>
                        </el-form-item>
                        <el-form-item label="转账地址">
            ...
            <el-table-column :format="formatStatus" label="是否完成"></el-table-column>
            <el-table-column prop="finished_at" label="完成时间"></el-table-column>
