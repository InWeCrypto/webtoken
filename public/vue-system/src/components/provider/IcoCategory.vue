    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-menu"></i> 应用分类</el-breadcrumb-item>
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="param" label="参数/url"></el-table-column>
        ...
        <el-dialog title="添加" :visible.sync="addRoleDialog">
            <el-form :model="role" :rules="rules" ref="addRole">
                ...
                <el-form-item label="类型" prop="type">
                    <el-select v-model="role.type" placeholder="请选择分类">
                        <el-option
                                v-for="item in [{id:1,name:'native'},{id:2,name:'web'}]"
                                :key="item.id"
                                :label="item.name"
                                :value="item.id">
                        </el-option>
                ...
                <el-form-item label="参数/url" prop="param">
                    <el-input v-model="role.param" placeholder="请输入参数/url"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    export default {
        ...
        methods: {
            ...
            formatType(index, row) {
                return row.type == 1 ? 'native' : 'web'
            },
            getData(){
                let self = this;
            ...
            handleAdd(index, row){
                this.role = {img: '', name: '', type: 2, param: ''};
