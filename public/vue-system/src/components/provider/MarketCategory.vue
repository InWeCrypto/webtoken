    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-menu"></i> 行情分类管理</el-breadcrumb-item>
        ...
        <el-table :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="flag" label="标记(用于关联查询)"></el-table-column>
        ...
        <el-dialog title="添加" :visible.sync="addRoleDialog">
            <el-form :model="role" :rules="rules" ref="addRole">
                ...
                <el-form-item label="来源">
                    <el-input v-model="role.source" placeholder="请输入来源"></el-input>
                </el-form-item>
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    icon: [
                        {required: true, message: '请上传icon图片'}
                    ],
//                    token_: [
